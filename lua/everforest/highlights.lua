...
highlights.generate_syntax = function(palette, options)
  ...
  local syntax = {
    ...
    BufferCurrentADDED = syntax_entry(palette.aqua, palette.bg0),
    ...
    BufferVisibleADDED = syntax_entry(palette.aqua, palette.bg0),
    BufferVisibleCHANGED = syntax_entry(palette.blue, palette.bg0),
    BufferVisibleDELETED = syntax_entry(palette.red, palette.bg0),
    BufferVisibleERROR = syntax_entry(palette.red, palette.bg0),
    BufferVisibleHINT = syntax_entry(palette.yellow, palette.bg0),
    BufferVisibleINFO = syntax_entry(palette.aqua, palette.bg0),
    BufferVisibleWARN = syntax_entry(palette.orange, palette.bg0),
    ...
    BufferInactiveADDED = syntax_entry(palette.grey1, palette.bg0),
    BufferInactiveCHANGED = syntax_entry(palette.grey1, palette.bg0),
    BufferInactiveDELETED = syntax_entry(palette.grey1, palette.bg0),
    BufferInactiveERROR = syntax_entry(palette.grey1, palette.bg0),
    BufferInactiveHINT = syntax_entry(palette.grey1, palette.bg0),
    BufferInactiveINFO = syntax_entry(palette.grey1, palette.bg0),
    BufferInactiveWARN = syntax_entry(palette.grey1, palette.bg0),
