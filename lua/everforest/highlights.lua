...
highlights.generate_syntax = function(palette, options)
  local syntax = {
    ...
    -- romgrk/barbar.nvim
    BufferCurrent = syntax_entry(palette.fg, palette.bg4),
    BufferCurrentIndex = syntax_entry(palette.fg, palette.bg4),
    BufferCurrentMod = syntax_entry(palette.blue, palette.bg4),
    BufferCurrentSign = syntax_entry(palette.statusline1, palette.bg4),
    BufferCurrentTarget = syntax_entry(palette.red, palette.bg4, { styles.bold }),
    BufferVisible = syntax_entry(palette.fg, palette.bg2),
    BufferVisibleIndex = syntax_entry(palette.fg, palette.bg2),
    BufferVisibleMod = syntax_entry(palette.blue, palette.bg2),
    BufferVisibleSign = syntax_entry(palette.statusline1, palette.bg2),
    BufferVisibleTarget = syntax_entry(palette.yellow, palette.bg2, { styles.bold }),
    BufferInactive = syntax_entry(palette.grey1, palette.bg2),
    BufferInactiveIndex = syntax_entry(palette.grey1, palette.bg2),
    BufferInactiveMod = syntax_entry(palette.grey1, palette.bg2),
    BufferInactiveSign = syntax_entry(palette.grey0, palette.bg2),
    BufferInactiveTarget = syntax_entry(palette.yellow, palette.bg2, { styles.bold }),
    BufferTabpages = syntax_entry(palette.bg0, palette.statusline1, { styles.bold }),
    BufferTabpageFill = syntax_entry(palette.bg0, palette.bg0),
    ...
    NeoTreeExpander = syntax_entry(palette.grey1, palette.none),
    NeoTreeIndentMarker = syntax_entry(palette.grey1, palette.none),
    NeoTreeRootName = syntax_entry(palette.blue, palette.none, { styles.bold }),
